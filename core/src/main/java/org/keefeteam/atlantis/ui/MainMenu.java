...
public class MainMenu extends ChoiceMenu {
    ...
    public MainMenu() {
        super(List.of("Start", "Help", "Credits", "Exit"), (s, gameState) -> {
            switch (s) {
                case "Help":
                    DialogueMenu dialogueMenu = new DialogueMenu("Explore Atlantis to discover the secrets within. Use WASD to move around, E to interact with things in front of you, and Q to open your inventory. Use your mind, exploration, and experimentation to work out puzzles and give the correct answers.", () -> {
